...
from .models import LoginHistoryCreate, LoginHistoryInDb
...
class LoginHistoryService:
    ...
    async def get_list(self, user_id: uuid.UUID) -> list[LoginHistoryInDb]:
        return await self._repository.get_list_by_user(user_id)
