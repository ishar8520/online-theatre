...
docker_compose() {
    ...
    AUTH_POSTGRESQL_PASSWORD=123456 \
    RATELIMITER_TIMES=1000 \
    RATELIMITER_SECONDS=1 \
    NOTIFICATIONS_QUEUE_RABBITMQ_USERNAME=admin \
    NOTIFICATIONS_QUEUE_RABBITMQ_PASSWORD=123456 \
    ADMIN_PANEL_POSTGRESQL_DATABASE=admin_panel \
    ADMIN_PANEL_POSTGRESQL_USERNAME=admin_panel \
    ADMIN_PANEL_POSTGRESQL_PASSWORD=secret \
    POSTGRESQL_BILLING_DATABASE=billing \
    POSTGRESQL_BILLING_USERNAME=admin \
    POSTGRESQL_BILLING_PASSWORD=123456 \
