...
async def create_elasticsearch_index(
    ...
    async def _create_elasticsearch_index(*, index_name: str) -> None:
        ...
        elasticsearch_indices.append(elasticsearch_index)
        await elasticsearch_index.create_index()

    yield _create_elasticsearch_index

    for _elasticsearch_index in elasticsearch_indices:
